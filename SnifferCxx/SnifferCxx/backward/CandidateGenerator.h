...
namespace Backward {
	...
	public:
		...
		std::vector<Model::Candidate> calcCandidates(const Model::Coordinate & curPos, int time_count, Model::unit_t distance, const Model::Hypotheses & hyps) const;
		Model::Candidate calcBestCandidate(const Model::Coordinate & curPos, int time_count, Model::unit_t distance, const Model::Hypotheses & hyps) const;
