...
namespace Backward {
    ...
    public:
        ...
        std::shared_ptr<std::vector<Model::Hypothesis>> updateHypotheses(const std::vector<std::shared_ptr<Model::Hypothesis>> & hyps, const Model::Map3D & map, size_t time_count, const std::vector<Model::Leak> & detections) const;
